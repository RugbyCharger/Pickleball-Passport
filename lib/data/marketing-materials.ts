...
export const MARKETING_MATERIALS: MarketingMaterial[] = [
  // Email Templates
  {
    ...
    description: 'Professional introduction email to introduce Pickleball Passport to your club members. Includes personalization tokens for club name and director name.',
  ...
  // Social Media
  {
    ...
    description: 'Square image (1080x1080) with caption for Facebook. Perfect for introducing Pickleball Passport to your club community.',
  ...
  // Presentations
  {
    ...
    description: 'Complete PowerPoint presentation (20 slides) covering all aspects of Pickleball Passport. Perfect for club meetings and preview events.',
