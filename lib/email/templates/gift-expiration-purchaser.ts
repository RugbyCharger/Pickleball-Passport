/**
 * Gift Expiration Notification Email Template (Purchaser)
 *
 * Sent to purchaser when their gift expires after 30 days without response
 */
...
export function generateGiftExpirationPurchaserEmail(data: GiftExpirationPurchaserData): {
  ...
  const content = `
    <div style="text-align: center; margin: 0 0 32px 0;">
      ...
      <h1 style="margin: 0; font-size: 28px; color: #111827;">Gift Expired - Refund Processed</h1>
    </div>
    ...
    <p style="font-size: 16px; color: #4b5563; line-height: 1.7; text-align: center; margin: 0 0 24px 0;">
      Unfortunately, your gift to <strong>${data.recipientName}</strong> has expired after 30 days without a response.
    </p>
