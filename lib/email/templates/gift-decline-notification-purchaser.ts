/**
 * Gift Decline Notification Email Template (Purchaser)
 *
 * Sent to purchaser when recipient declines the gift
 */
...
export function generateGiftDeclineNotificationPurchaserEmail(data: GiftDeclineNotificationPurchaserData): {
  ...
  const declineReasonHtml = data.declineReason
    ...
    <div style="margin: 24px 0; padding: 16px; background-color: #f3f4f6; border-radius: 8px; border-left: 4px solid #9ca3af;">
      <p style="margin: 0 0 8px 0; color: #6b7280; font-size: 14px; font-weight: 600;">Reason provided:</p>
  ...
  const content = `
    <div style="text-align: center; margin: 0 0 32px 0;">
      ...
      <h1 style="margin: 0; font-size: 28px; color: #111827;">Gift Declined - Refund Processed</h1>
    </div>
    ...
    <p style="font-size: 16px; color: #4b5563; line-height: 1.7; text-align: center; margin: 0 0 24px 0;">
      Unfortunately, <strong>${data.recipientFirstName} ${data.recipientLastName}</strong> has declined your gift booking.
    </p>
    ...
    <h2 style="color: #111827; font-size: 18px; margin: 32px 0 16px 0;">Booking Details</h2>
    ...
    <div style="margin: 16px 0; padding: 20px; background-color: #f9fafb; border-radius: 8px;">
      <table style="width: 100%; border-collapse: collapse;">
        ...
        <tr>
          <td style="padding: 8px 0; color: #6b7280; font-size: 14px; border-top: 1px solid #e5e7eb; padding-top: 12px;">Original Amount:</td>
    ...
    <div style="margin: 32px 0; padding: 20px; background-color: #f0f9ff; border-radius: 8px; border-left: 4px solid #2563eb;">
      <p style="margin: 0; color: #1e40af; font-size: 14px; line-height: 1.7;">
        We're sorry this didn't work out. If you'd like to send another gift or have any questions, we're here to help.
      </p>
    </div>
  ...
  const subject = `Gift Declined - Refund Processed - ${data.bookingReference}`;
