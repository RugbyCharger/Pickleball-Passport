    ...
    <main className="min-h-screen bg-gradient-to-b from-[#FDF8F3] to-white">
      ...
      <section className="py-16 sm:py-24 bg-[#FDF8F3]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#D4AF37]/10 text-[#003D5C] text-sm font-medium mb-6">
                <Sun className="w-4 h-4 text-[#D4AF37]" />
                The Beginning
              </div>
              <h2 className="text-3xl sm:text-4xl font-serif font-bold text-[#003D5C] mb-8">
                Our Story
              </h2>
              <div className="space-y-5 text-[#003D5C]/70 leading-relaxed">
                <p>
                ...
                <p className="font-medium text-[#003D5C]">
            ...
            {/* Stats Grid */}
            <div className="bg-white rounded-3xl shadow-xl shadow-[#003D5C]/10 p-10 border border-[#D4AF37]/10">
              <div className="grid grid-cols-2 gap-8">
                {stats.map((stat, idx) => (
                  <div key={idx} className="text-center p-6 rounded-2xl bg-gradient-to-br from-[#F5E6D3]/50 to-white">
                    <div className="text-4xl sm:text-5xl font-bold text-[#003D5C] mb-2">
                      {stat.value}
                    </div>
                    <div className="text-[#003D5C]/60 font-medium">{stat.label}</div>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-[#F5E6D3] to-[#FDF8F3]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Mission Card */}
            <div className="bg-white rounded-3xl shadow-xl shadow-[#003D5C]/10 p-10 relative overflow-hidden border border-[#D4AF37]/10 group hover:-translate-y-1 transition-transform">
              <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-[#003D5C] to-[#4AA4B5]" />
              <div className="absolute top-8 right-8 opacity-5 group-hover:opacity-10 transition-opacity">
                <Target className="w-32 h-32 text-[#003D5C]" />
              </div>
              <div className="relative z-10">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#003D5C] to-[#4AA4B5] flex items-center justify-center mb-6 shadow-lg">
                  <Target className="h-8 w-8 text-white" />
                </div>
                <h3 className="text-2xl font-serif font-bold text-[#003D5C] mb-4">Our Mission</h3>
            ...
            {/* Vision Card */}
            <div className="bg-white rounded-3xl shadow-xl shadow-[#003D5C]/10 p-10 relative overflow-hidden border border-[#D4AF37]/10 group hover:-translate-y-1 transition-transform">
              <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-[#D4AF37] to-[#E5C969]" />
              <div className="absolute top-8 right-8 opacity-5 group-hover:opacity-10 transition-opacity">
                <Sparkles className="w-32 h-32 text-[#D4AF37]" />
              </div>
              <div className="relative z-10">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#D4AF37] to-[#E5C969] flex items-center justify-center mb-6 shadow-lg">
                  <Sparkles className="h-8 w-8 text-[#003D5C]" />
                </div>
                <h3 className="text-2xl font-serif font-bold text-[#003D5C] mb-4">Our Vision</h3>
                <p className="text-[#003D5C]/70 leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, idx) => (
              <div key={idx} className="text-center group">
                ...
                <h3 className="text-xl font-serif font-bold text-[#003D5C] mb-3">{value.title}</h3>
                <p className="text-[#003D5C]/70 leading-relaxed">{value.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {team.map((member, idx) => (
              ...
              >
                <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-[#D4AF37] to-[#E5C969] flex items-center justify-center mx-auto mb-6 text-[#003D5C] text-2xl font-bold shadow-xl group-hover:scale-110 transition-transform">
                  {member.avatar}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-3xl shadow-xl shadow-[#003D5C]/10 p-10 border border-[#D4AF37]/10">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div className="p-4">
                <div className="w-14 h-14 mx-auto mb-4 rounded-xl bg-[#003D5C]/10 flex items-center justify-center">
                  <Shield className="w-7 h-7 text-[#003D5C]" />
                </div>
                <div className="text-lg font-bold text-[#003D5C]">JCI Accredited</div>
                <div className="text-sm text-[#003D5C]/60">Partner Facilities</div>
              </div>
              <div className="p-4">
                ...
                <div className="text-lg font-bold text-[#003D5C]">4.9 Rating</div>
                <div className="text-sm text-[#003D5C]/60">Guest Reviews</div>
              </div>
              <div className="p-4">
                ...
                <div className="text-lg font-bold text-[#003D5C]">Licensed</div>
                <div className="text-sm text-[#003D5C]/60">Medical Tourism</div>
              </div>
              <div className="p-4">
                ...
                <div className="text-lg font-bold text-[#003D5C]">60-70%</div>
                <div className="text-sm text-[#003D5C]/60">Cost Savings</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-[#F5E6D3] to-[#FDF8F3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-[#003D5C]/70 mb-10 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/contact">
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-[#003D5C] text-[#003D5C] hover:bg-[#003D5C] hover:text-white font-semibold px-10 py-7 text-lg rounded-xl"
              >
                Contact Us
              </Button>
            </Link>
