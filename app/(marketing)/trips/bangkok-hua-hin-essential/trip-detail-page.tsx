...
import { TripSectionContentEssential } from '@/components/trips/trip-section-content-essential';

export function BangkokHuaHinEssentialPage() {
  return (
    <main className="min-h-screen bg-[#FDF8F3]">
      ...
      <TripDetailLayout
        tripName="Bangkok + Hua Hin Essential - 9 Days / 8 Nights"
        cities="The Peninsula Bangkok · Dusit Thani Hua Hin"
        dates="June 1 - June 9, 2026"
        price={3488}
        depositAmount={872}
        ContentComponent={TripSectionContentEssential}
      />

      {/* Cross-link to Ultimate */}
