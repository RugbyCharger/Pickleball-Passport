...
export const metadata: Metadata = {
  ...
  description:
    'The January 14–22, 2027 departure is the only Bangkok + Chiang Mai trip with an optional Phuket extension. 9 days. Our 5-Star Bangkok riverside hotel · Our 5-Star Chiang Mai Riverside Resort. From $4,860/person (High Season). Extend into Phuket at Banyan Tree or Angsana Laguna.',
  keywords: [
