...
import { Sparkles, MapPin, Calendar, Users, Trophy, Leaf } from 'lucide-react';
  ...
  return (
    <main className="min-h-screen bg-[#FDF8F3]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm text-white/90 text-sm font-medium mb-6">
              <Leaf className="w-4 h-4 text-[#B08D55]" />
              Seasonal Route: November - January
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-[#1D2D44]/70 leading-relaxed max-w-2xl mx-auto">
              Available exclusively from November through January, when Chiang Mai is at its best.
              Cool temperatures, clear skies, and the Lanna cultural season in full swing.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-[#B08D55]/15 shadow-sm p-6 sm:p-8">
              <div className="flex items-center gap-3 mb-3">
                <span className="inline-flex items-center px-3 py-1.5 rounded-full bg-[#B08D55] text-white text-xs font-medium">Chiang Mai</span>
                <span className="text-sm font-medium text-[#1D2D44]/60">7 Nights</span>
              </div>
              <h4 className="font-serif text-xl font-bold text-[#1D2D44] mb-2">Anantara Chiang Mai Resort</h4>
              <p className="text-[#1D2D44]/70 text-sm leading-relaxed">
                Riverside five-star resort in the heart of the old city. Spa, heritage architecture,
                cooking classes, and access to Chiang Mai's best pickleball courts.
              </p>
            </div>
          ...
          <div className="text-center mt-12">
            <p className="text-[#1D2D44]/60 text-sm mb-4">
              Dates for Nov/Dec 2026 will be announced once the group confirms.
            </p>
            <button
              type="button"
              onClick={() => setWaitlistOpen(true)}
      ...
      <WaitlistModal
        ...
        tripName="Bangkok + Chiang Mai - 15 Days / 14 Nights (Nov-Jan)"
      />
    </main>
  );
}
