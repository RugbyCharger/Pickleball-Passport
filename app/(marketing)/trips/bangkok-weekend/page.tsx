...
const itinerary = [
  {
    ...
    details: 'Check in to The Peninsula Bangkok. Welcome dinner at Thiptara, the hotel\'s riverside Thai restaurant.',
  },
  {
    day: 'Day 2',
    label: 'Friday',
...
const included = [
  '3 nights at The Peninsula Bangkok (Deluxe Room, daily breakfast)',
...
const departures = [
  { dates: 'Jul 16–19', year: '2026', note: 'With BK Karunakaran', featured: true },
  { dates: 'Aug 13–16', year: '2026', note: null, featured: false },
  { dates: 'Sep 10–13', year: '2026', note: null, featured: false },
  { dates: 'Oct 8–11', year: '2026', note: null, featured: false },
  { dates: 'Nov 5–8', year: '2026', note: null, featured: false },
  { dates: 'Dec 3–6', year: '2026', note: null, featured: false },
];
    ...
    <main className="min-h-screen bg-[#FDF8F3]">
      ...
      <section className="relative overflow-hidden text-white">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
          ...
          <p className="text-xl text-white/75 mb-2">The Peninsula Bangkok · 2 Sessions with BK</p>
            ...
            {departures.map((dep) => (
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  <Calendar className={`w-3.5 h-3.5 ${dep.featured ? 'text-[#B08D55]' : 'text-[#B08D55]'}`} />
