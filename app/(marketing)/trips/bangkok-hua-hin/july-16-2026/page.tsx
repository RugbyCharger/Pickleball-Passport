...
export const metadata: Metadata = {
  ...
  description:
    'The July 16–24 Bangkok + Hua Hin departure is the only summer trip joined by BK Karunakaran — PPR Certified Pro Coach, Professional Pickleball Player, and Content Creator. 9 days. The Peninsula Bangkok. Anantara Hua Hin Resort. From $3,888/person.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'The only summer departure joined by BK Karunakaran, PPR Certified Pro Coach. 9 days across Bangkok and Hua Hin. The Peninsula Bangkok · Anantara Hua Hin Resort. From $3,888/person.',
