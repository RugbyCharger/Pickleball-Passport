...
export function ComingSoonCard({ destination, subtitle }: ComingSoonCardProps) {
  return (
    <div className="bg-white/60 rounded-2xl shadow-md overflow-hidden border border-[#B08D55]/10 h-full flex flex-col opacity-80">
      {/* Hero image area - muted */}
      <div className="relative h-48 sm:h-56 bg-gradient-to-br from-gray-200 via-gray-300 to-gray-200 overflow-hidden">
        {/* Coming Soon badge */}
