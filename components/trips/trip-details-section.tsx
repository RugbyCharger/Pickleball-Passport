...
const includedItems = [
  '8 nights at handpicked boutique hotels (2 unique properties, 2 cities)',
  'Daily breakfast at all hotels (8 breakfasts)',
  '4 group dinners: welcome dinner in each city + Bangkok farewell + Hua Hin closing dinner',
  '1 domestic transfer (Bangkok \u2192 Hua Hin)',
  'All private ground transportation (air-con vans, airport transfers)',
  '5 pickleball sessions with court fees, equipment, and structured programming',
...
const extrasItems = [
  ...
  'Beach club day beds and loungers',
