...
Play with intention, focus on the mental game, and connect deeply with fellow players. This isn't about competition—it's about joy.`,
  ...
  const trips = await prisma.trip.createMany({
    data: [
      {
        name: 'Phuket Pure Play - January 2026',
      ...
      {
        name: 'Phuket Pure Play - February 2026',
        destination: 'Phuket, Thailand',
      ...
      {
        name: 'Smile Makeover - March 2026',
        destination: 'Phuket, Thailand',
      ...
      {
        name: 'Spiritual Journey - April 2026',
        destination: 'Phuket, Thailand',
      ...
      {
        name: 'Total Transformation - May 2026',
        destination: 'Phuket, Thailand',
