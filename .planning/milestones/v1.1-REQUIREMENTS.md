# Requirements Archive: v1.1 Gift Booking
...
- [x] **GIFT-10**: Recipient can view gift details via acceptance link
- [x] **GIFT-11**: Recipient can create account or login to accept gift
